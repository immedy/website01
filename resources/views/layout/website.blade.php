                    ...
                    <div class=" gx-5">
                        <div class="pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Jalan Poros Kota Bangun-Tenggarong KM5, Kecamatan Kota Bangun,
                                    Kabupaten Kutai Kartanegara, Kalimantan Timur. 75561</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">dayaku_raja@yahoo.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">08115818988</p>
                            </div>
