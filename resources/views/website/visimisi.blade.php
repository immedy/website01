    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Motto Rumah Sakit Dayaku Raja</h5>
                <h1 class="mb-0">"Melayani Sepenuh Dayaku"</h1>
            </div>
            <div class="row g-0">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                        ...
                        <div class="p-5 pt-0" style="height: 400px">
                            ...
                            <div class="d-flex justify-content-between mb-3">2. <span>Mewujudkan Rumah Sakit yang mudah
                                    dijangkau oleh seluruh masyarakat</span></div>
                            <div class="d-flex justify-content-between mb-3">3. <span>Menjamin terciptanya pelayanan Rumah
                                    Sakit yang berorientasi pada kebutuhan pasien</span></div>
                            <div class="d-flex justify-content-between mb-2">4. <span>Menciptakan tata kelola organisasi
                                    berdasarkan prinsip good governance</span></div>
                        </div>
                    </div>
                </div>
